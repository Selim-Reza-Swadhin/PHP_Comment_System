 	...
 	<div class="box">
 		<ul>
 			<?php 
 			 ...
 			 ?>
 			<li><b style="background: green; color: #fff;padding: 5px;"><?= ucwords($data['name']); ?></b> - <?= $data['comment'] ?> - <span style="background: blueviolet; color: #fff;padding: 1px;"><?= $com->dateFormat($data['comment_time']); ?></span><br></li>
 			<?php } ?>
 		</ul>
 	</div><br><br>
 	<center>
